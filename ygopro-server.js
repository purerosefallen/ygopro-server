...
(function() {
  ...
  Room = (function() {
    function Room(name, hostinfo) {
      var draw_count, error, extend_time, lflist, list_official_to_pre, list_pre_to_official, official_database, param, pre_release_database, rule, start_hand, start_lp, temp_list, time_limit;
